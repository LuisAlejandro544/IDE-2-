...
class AiAgentService {
    ...
    fun streamUserPrompt(
        ...
        val systemInstruction = """
            ...
            SOPORTE DE LIBRERÍAS Y MÓDULOS ES EN DEVSTUDIO:
            - DevStudio soporta nativamente Import Maps y ES Modules en proyectos Web y React.
            - Cuando el usuario solicite librerías externas (ej: confetti, lucide-react, lodash, framer-motion, etc.), utiliza `<script type="importmap">` en `index.html` vinculando los paquetes desde CDNs como `https://esm.sh/<paquete>`.
            - En archivos JS/React, usa la sintaxis estándar `import ... from 'nombre-paquete'` cargando los scripts como `<script type="module" src="...">` o `<script type="text/babel" data-type="module" src="...">`.
