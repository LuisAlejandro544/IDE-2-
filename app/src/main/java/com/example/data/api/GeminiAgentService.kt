    ...
    suspend fun processUserPrompt(
        ...
        try {
            val systemInstruction = """
                ...
                Tu objetivo es ayudar al programador creando, modificando o explicando código web (HTML, CSS, JavaScript, React, Markdown, JSON).
                Soportas nativamente la integración de librerías mediante Import Maps (`<script type="importmap">`) y Módulos ES (`import ... from 'package'` vía esm.sh) sin requerir bundlers.
